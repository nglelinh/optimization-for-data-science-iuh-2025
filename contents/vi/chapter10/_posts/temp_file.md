...
Tìm $$$u^*$$$ thỏa điều kiện bù:
- Ràng buộc 1 chặt → $$$u_1^*$$$ bất kỳ
- Ràng buộc 2 chặt → $$$u_2^*$$$ bất kỳ
- $$$x_1^* > 0$$$ → $$$u_1^* + 2u_2^* = 2$$
- $$$x_2^* > 0$$$ → $$$u_1^* + u_2^* = 3$$
...
Nhưng $$$u_2^* = -1 < 0$$$ không khả thi! Có vấn đề...

**Sửa lại:** Kiểm tra $$$x^* = (3, 0)$$$:
- $$$3 + 0 = 3 \not\geq 4$$$ ✗

Nghiệm tối ưu thực sự cần giải bằng phương pháp đồ thị hoặc simplex.
...
**Shadow prices:**
- Lao động: $$$u_1^* = 10$$$ nghìn đồng/giờ
- Máy móc: $$$u_2^* = 20$$$ nghìn đồng/giờ

**b) Quyết định mua:**

Giá mua: 12 nghìn đồng/giờ  
Giá trị biên: $$$u_1^* = 10$$$ nghìn đồng/giờ

$$12 > 10$$$ → **Không nên mua** (lỗ 2 nghìn/giờ)

**c) Độ nhạy:**

Tăng 5 giờ lao động:
$$$\Delta f \approx u_1^* \times 5 = 10 \times 5 = 50 \text{ nghìn đồng}$$$

Lợi nhuận mới: $$$40(40) + 30(20) + 50 = 2250$$$ nghìn đồng
...
Tài nguyên: 100 giờ lao động, 80 giờ máy, 90 kg nguyên liệu.
...
$$
\begin{align}
\min_{u} \quad & 100u_1 + 80u_2 + 90u_3 \\
\text{s.t.} \quad & 2u_1 + u_2 + 3u_3 \geq 5 \\
& u_1 + 2u_2 + 2u_3 \geq 4 \\
& 3u_1 + 2u_2 + u_3 \geq 6 \\
& u_1, u_2, u_3 \geq 0
\end{align}
...
Từ CS (tất cả chặt, tất cả biến dương):
...
Giải hệ (khó, cần máy tính):
$$u_1 \approx 1.27$$$, $$$u_2 \approx 0.82$$$, $$$u_3 \approx 0.55$$

**c) Quyết định:**

**Phương án 1:** Lao động
- Chi phí: $$$1.5 \times 10 = 15$$$ triệu
- Lợi ích: $$$1.27 \times 10 = 12.7$$$ triệu
- **Lỗ: 2.3 triệu**

**Phương án 2:** Nguyên liệu
- Chi phí: $$$1 \times 10 = 10$$$ triệu
- Lợi ích: $$$0.55 \times 10 = 5.5$$$ triệu
- **Lỗ: 4.5 triệu**

**Kết luận:** Cả hai đều lỗ, nếu phải chọn thì chọn phương án 1 (lỗ ít hơn).
