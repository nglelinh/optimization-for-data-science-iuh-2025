...
Further reading (not core): SAM (Foret et al., ICLR 2021) asks for *flat* minima via a local max; Muon and Sophia are 2023–2024 optimizer-zoo case studies. One paragraph in a seminar is enough.
